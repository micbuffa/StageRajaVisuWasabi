    ...
    function (Dashboard, DatabaseLib, LibCava, AlgCluster, NumericGlyph,
        ...
        function _showChartRoot(idChart, novo) {
            ...
            switch (_selectedQuery) {
                ...
                case 7: _loadDataProcess("json/dataUFRGS-2004-2011-CG.json", 7, idChart);
                    break;
                case 8: _loadDataProcess("json/json.json", 8, idChart);
                    break;
                case 9: _loadDataProcess("json/transformedData.json", 9, idChart);
                break;
                case 10: _loadDataProcess("json/wasabidata.json", 10, idChart);
            }
        }
        //------ Loads a new dataset
        ...
        function _inicContextMenu() {
            _dashboard.setItensContextMenu(TC_NodeEdge, [
                ...
                { label: "Paper List", fActionNode: _fActionNodeNE_PL, fActionEdge: _fActionNotImplemented }
        ...
        function _fActionEdgeNE_GM(edge, parentId) {
            ...
            _dashboard.addChart(parentId, {
                id: _chart.view.idChart(), title: title, typeChart: "GM", hidden: false,
        ...
        function _showClusterVis(node, parentId) {
            ...
            _dashboard.addChart(parentId, {
                id: _chart.view.idChart(), title: title, typeChart: "CV", hidden: false,
                x: _chart.view.getPosition().x, y: _chart.view.getPosition().y, chart: _chart.chart, view: _chart.view
            });
        ...
        function _showPapersList(node, parentId, isFromEdge, secondNode, isFromCluster) {
            ...
            _dashboard.addChart(parentId, {
                id: _chart.view.idChart(), title: title, typeChart: "PL", hidden: false,
                x: _chart.view.getPosition().x, y: _chart.view.getPosition().y, chart: _chart.chart, view: _chart.view
            });
